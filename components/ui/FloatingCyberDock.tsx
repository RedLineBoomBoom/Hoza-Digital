...
export const FloatingCyberDock: React.FC<FloatingCyberDockProps> = ({
  ...
  return (
    <aside aria-label="Quick Actions Dock" className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 px-4 select-none">
      <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-2 bg-[#0C0C0C]/95 tactical-corners border border-white/20 hover:border-[#D4FF00]/50 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.8),0_0_16px_rgba(212,255,0,0.15)] transition-all duration-300">
        ...
        {onOpenCommandPalette && (
          <button
            ...
            className="font-mono text-[11px] text-[#D4FF00] hover:text-white px-2 py-1 transition-colors flex items-center gap-1 cursor-pointer bg-white/5 rounded border border-[#D4FF00]/30 hover:border-[#D4FF00]"
          >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="px-2.5 py-1 bg-emerald-500 hover:bg-emerald-400 text-[#09090B] font-mono text-[11px] font-bold flex items-center gap-1.5 transition-all shadow-sm"
        >
